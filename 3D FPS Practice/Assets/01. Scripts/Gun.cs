...
public class Gun : MonoBehaviour
{
    ...
    public ParticleSystem muzzleFalshEffect; // 총구 화염 효과
    ...
    private AudioSource gundAudioPlayer; // 총 소리 재생기
    ...
    {
        // 현재 상태가 발사 가능한 상태
        // && 마지막 총 발사 시점에서 gunData.timeBetFire 이의 시간이 지남
